...
try {
  ...
  $sql = "SELECT * FROM Recipe AS r, Instruction AS i, RecipeTime AS rt
          ...
          WHERE NOT EXISTS ((SELECT Username FROM BookUser) EXCEPT (SELECT ur.Username FROM UserFavoritesRecipes As ur WHERE ur.ReID = r1.ReID)))";
...
<h2>Recipes Favotied by All Users</h2>
