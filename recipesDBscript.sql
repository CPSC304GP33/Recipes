...
Instructions VARCHAR(8000) PRIMARY KEY,
ServingSize INTEGER
);

INSERT INTO Instruction VALUES ('Mix ingredients into a pan then put it into the oven.', 8)
INSERT INTO Instruction VALUES ('Mix ingredients in a bowl. Separate into even balls. Put balls on baking sheet then place it into the oven.', 20)
INSERT INTO Instruction VALUES ('Add the dry ingredients to the mug and stir. Add the wet ingredients and stir. Put all in the microwave on high until the mixture is cooked which takes about 1 minute 40 seconds for a 1000 watt microwave. Top with ice cream.', 1)
INSERT INTO Instruction VALUES ('Cook sauce. Cook lasagna noodles. Spread layers of noodle, cheese and sauce into the oven-safe pan. Top with more cheese then bake.', 4)
INSERT INTO Instruction VALUES ('Mix ingredients in a bowl. Use a hand mixer to make the merengue. Spread mix on the baking sheet in circles. Bake the macaron shells. Sandwich the merengue in between the shells', 10)
...
Instructions VARCHAR(8000) UNIQUE NOT NULL,
 	FOREIGN KEY (PrepTime, CookTime) REFERENCES RecipeTime
		ON DELETE NO ACTION,
            FOREIGN KEY (Instructions) REFERENCES Instruction
ON DELETE CASCADE
);

INSERT INTO Recipe VALUES ('R1', 'Easy', 'Tiramisu', '00:10:00', '00:50:00', 'Mix ingredients into a pan then put it into the oven.')
INSERT INTO Recipe VALUES ('R2', 'Easy', 'Chocolate Cookie', '00:20:00', '00:15:00', 'Mix ingredients in a bowl. Separate into even balls. Put balls on baking sheet then place it into the oven.')
INSERT INTO Recipe VALUES ('R3', 'Medium', 'White Chocolate Brownie', '00:03:00', '00:10:00', 'Add the dry ingredients to the mug and stir. Add the wet ingredients and stir. Put all in the microwave on high until the mixture is cooked which takes about 1 minute 40 seconds for a 1000 watt microwave. Top with ice cream.')
INSERT INTO Recipe VALUES ('R4', 'Hard', 'Lasagna', '03:00:00', '01:00:00', 'Cook sauce. Cook lasagna noodles. Spread layers of noodle, cheese and sauce into the oven-safe pan. Top with more cheese then bake.')
INSERT INTO Recipe VALUES ('R5', 'Hard', 'Macaron', '04:00:00', '00:30:00', 'Mix ingredients in a bowl. Use a hand mixer to make the merengue. Spread mix on the baking sheet in circles. Bake the macaron shells. Sandwich the merengue in between the shells')
...
FOREIGN KEY (IName) REFERENCES Ingredient(Name)
	ON DELETE NO ACTION,
FOREIGN KEY (ReID) REFERENCES Recipe
	ON DELETE CASCADE
);
...
Name VARCHAR(40),
ReID CHAR(20),
PRIMARY KEY (Name, ReID),
FOREIGN KEY (Name) REFERENCES Tag
	ON DELETE CASCADE,
FOREIGN KEY (ReID) REFERENCES Recipe
	ON DELETE CASCADE);
...
CREATE TABLE FinalRating (
    ...
    FOREIGN KEY (UserName) REFERENCES BookUser
    	ON DELETE CASCADE,
    FOREIGN KEY (RID) REFERENCES RatingResult
    	ON DELETE NO ACTION,
    FOREIGN KEY (ReID) REFERENCES Recipe
	ON DELETE CASCADE
);
...
AverageScore REAL,
NumOfUsers INTEGER,
FOREIGN KEY (AverageScore) REFERENCES AveRating
	ON DELETE NO ACTION
);
